...
%			\begin{figure}[h]
%				\centering
%				\includegraphics[width=.5\textwidth]{k17trans.png}
%				\caption{Raw data k17.}
%				\label{k17trans}
%			\end{figure}
%			\begin{figure}[h]
%				\centering
%				\includegraphics[width=.5\textwidth]{tres1hst.jpg}
...
%			\begin{figure}[h]
%				\centering
%				\includegraphics[width=.5\textwidth]{box_vis.png}
%				\caption{The visibility of one box during one window.}
%				\label{box}
%			\end{figure}
%			\begin{figure}[h]
%				\centering
%				\includegraphics[width=.5\textwidth]{sum_vis.png}
%				\caption{Overall visibilities for a window.} 
%				\label{sum_vis}
%			\end{figure}
...
%			\begin{figure}[h]
%				\centering
%				\includegraphics[width=.5\textwidth]{simplex.png}
%				\caption{Simplex.}
%				\label{simplex}
%			\end{figure}
...
%			\begin{figure}[h]
%				\centering
%				\includegraphics[width=.5\textwidth]{12_noise.png}
%				\caption{Example of Gaussian noise in a model.}
%				\label{noise}
%			\end{figure}
%		\item \ldots?
%	\end{enumerate}
